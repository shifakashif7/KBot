...
SYSTEM_PROMPT = (
    ...
    "SOURCE LINKS: When answering about any program, always include its URL from the list above as a markdown link: [Read more →](URL). "
    "If the retrieved context also contains a source URL, include that too. Never invent URLs not listed here.\n\n"
